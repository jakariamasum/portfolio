          ...
          <Card className="p-6 shadow-xl rounded-2xl backdrop-blur-lg bg-[#1E293B]/50 border border-[#2DD4BF]/20 overflow-hidden">
            ...
            >
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Visual Designer with 7+ years of experience. I&lsquo;m all about
                crafting user-friendly interfaces that are functional and
                visually compelling.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed">
                Born and raised in the beautiful Costa Rica. When I&lsquo;m not
                busy designing, you&lsquo;ll likely find me playing some board
